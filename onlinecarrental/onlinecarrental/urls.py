...
from app.views import IndexView,view_admin_account,check_car,upload_image,return_vehicle,start_booking,admin_booking_list,refund_order,order_list,update_order_status, report_defect,cancel_order, remove_from_cart,spare_parts,add_to_cart,order_history,checkout,booking_list, cancel_booking, get_unavailable_dates ,book_vehicle, book_vehicle, check_availability, car_list, car_details,login_view, signup_view, logout_view, vehicle_list, add_vehicle, update_vehicle, delete_vehicle, spare_parts_list, add_spare_part, update_spare_part, delete_spare_part, update_admin_account
from app.admin_views import admin_login, admin_dashboard, admin_logout
